...
- [ ] Enable "Switch to Desktop N" shortcuts for Amethyst workspace switching (Ctrl+1..9)
> Create the desired number of desktops in Mission Control first (Ctrl+Up, then "+" in the top-right corner).
>
> in German go to Systemeinstellungen > Tastatur > Tastaturkurzbefehle > Mission Control > "Zu Schreibtisch 1" bis "Zu Schreibtisch 9" aktivieren (Ctrl+1 bis Ctrl+9)
>
> in English go to System Settings > Keyboard > Keyboard Shortcuts > Mission Control > enable "Switch to Desktop 1" through "Switch to Desktop 9" (Ctrl+1 through Ctrl+9)
...
>
> in German go to Systemeinstellungen > Tastatur > Tastaturkurzbefehle > App-Kurzbefehle > Alle Programme > "Andere ausblenden" hinzufuegen mit Ctrl+Opt+Cmd+Shift+H
>
...
>
> in German go to Systemeinstellungen > Tastatur > Tastaturkurzbefehle > App-Kurzbefehle > Alle Programme > "Alle minimieren" hinzufuegen mit Ctrl+Opt+Cmd+Shift+M
>
...
>
> in German go to Systemeinstellungen > Tastatur > Tastaturkurzbefehle > App-Kurzbefehle > Alle Programme > "Alle schliessen" hinzufuegen mit Ctrl+Opt+Cmd+Shift+W
>
...
> in German go to Systemeinstellungen >
>
> in English got to System Preferences > Desktop & Dock > Desktop & Stage Manager > Click wallpaper to show desktop > Select "Only in Stage Manager"
